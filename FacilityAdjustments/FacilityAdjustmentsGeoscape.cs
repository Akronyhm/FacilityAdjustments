...
namespace FacilityAdjustments
{
	...
	public class FacilityAdjustmentsGSInstanceData
	{
	}
	...
	/// </summary>
	public class FacilityAdjustmentsGeoscape : ModGeoscape
	{
		/// <summary>
		...
		public override void OnGeoscapeStart() {
			...
			FacilityAdjustmentsMain main = (FacilityAdjustmentsMain)Main;
		}
		/// <summary>
		...
		public override object RecordGeoscapeInstanceData() {
			return new FacilityAdjustmentsGSInstanceData() {};
		}
		/// <summary>
		...
		public override void ProcessGeoscapeInstanceData(object instanceData) {
			FacilityAdjustmentsGSInstanceData data = (FacilityAdjustmentsGSInstanceData)instanceData;
		}

        public override void Init()
        {
			FacilityAdjustmentsLogger.Info("Initializing Geoscape");
            base.Init();
			FacilityAdjustmentsMain main = (FacilityAdjustmentsMain)Main;
			var harmony = (HarmonyLib.Harmony)main.HarmonyInstance;
			harmony.UnpatchAll(harmony.Id);
			harmony.PatchAll(System.Reflection.Assembly.GetExecutingAssembly());
			FTools.OutputHarmonyPatchInfo("FacilityAdjustments");
		}
